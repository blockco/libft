...
#    Updated: 2016/09/28 08:09:36 by ahunt            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = main.c ft_putchar.c ft_putstr.c ft_strcmp.c ft_strlen.c ft_strcpy.c \
	ft_strncpy.c ft_strdup.c ft_strcat.c ft_strncat.c ft_strlcat.c \
	ft_strlcpy.c ft_strchr.c ft_strrchr.c ft_bzero.c ft_memset.c ft_memcpy.c \
...
OBJ = main.o ft_putchar.o ft_putstr.o ft_strcmp.o ft_strlen.o ft_strcpy.o \
	ft_strncpy.o ft_strdup.o ft_strcat.o ft_strncat.o ft_strlcat.o \
	ft_strlcpy.o ft_strchr.o ft_strrchr.o ft_bzero.o ft_memset.o ft_memcpy.o \
